...
export function ProductCard({
  ...
  return (
    <article className="group relative flex flex-col h-full p-4 sm:p-5 bg-paper border border-line rounded-sm">
      {/* Plate */}
      <Link href={href} className="plate block aspect-[5/4] rounded-sm relative bg-paper" tabIndex={-1} aria-hidden="true">
